...
class ThumbsUpAni {
    ...
    loadImages() {
        const images = [
            'o_200522031835like1.ico',
            'o_200522031842like2.ico',
            'o_200522031850like3.ico',
            'o_200522031859like4.ico',
            'o_200522031907like5.ico',
            'o_200522031915like6.ico'
        ];
        const promiseAll = [];
        images.forEach((src) => {
            const p = new Promise(function (resolve) {
                ...
                img.src = 'https://blog-static.cnblogs.com/files/blogs/784957/' + src;
            });
            promiseAll.push(p);
        });
